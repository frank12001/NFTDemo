...
using Contract.Contracts.Character.ContractDefinition;

namespace Contract.Contracts.Character
{
    public partial class CharacterService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CharacterDeployment characterDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<CharacterDeployment>().SendRequestAndWaitForReceiptAsync(characterDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CharacterDeployment characterDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CharacterDeployment>().SendRequestAsync(characterDeployment);
        }

        public static async Task<CharacterService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CharacterDeployment characterDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, characterDeployment, cancellationTokenSource);
            return new CharacterService(web3, receipt.ContractAddress);
        }
        ...
        public CharacterService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
        ...
        public Task<string> ChangeBaseUrlRequestAsync(ChangeBaseUrlFunction changeBaseUrlFunction)
        {
             return ContractHandler.SendRequestAsync(changeBaseUrlFunction);
        }

        public Task<TransactionReceipt> ChangeBaseUrlRequestAndWaitForReceiptAsync(ChangeBaseUrlFunction changeBaseUrlFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(changeBaseUrlFunction, cancellationToken);
        }

        public Task<string> ChangeBaseUrlRequestAsync(string uri)
        {
            var changeBaseUrlFunction = new ChangeBaseUrlFunction();
                changeBaseUrlFunction.Uri = uri;
            
             return ContractHandler.SendRequestAsync(changeBaseUrlFunction);
        }

        public Task<TransactionReceipt> ChangeBaseUrlRequestAndWaitForReceiptAsync(string uri, CancellationTokenSource cancellationToken = null)
        {
            var changeBaseUrlFunction = new ChangeBaseUrlFunction();
                changeBaseUrlFunction.Uri = uri;
